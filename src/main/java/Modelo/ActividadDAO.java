...
Scanner sc = new Scanner(System.in);
    ...
    public ArrayList<Actividad> listaActividades() throws Exception {
        ...
        Query consulta = sesion.createNativeQuery("SELECT * FROM ACTIVIDAD");
    ...
    public void darAltaSocioEnActividad() {
        System.out.println("Indicar el numero de socio: ");
        String numeroSocio = sc.nextLine(); 
        System.out.println("Indicar el codigo de la actividad: ");
    ...
    public void darBajaSocioDeActividad() {
